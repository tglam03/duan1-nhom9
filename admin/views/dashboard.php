                                ...
                                <?php if (!empty($donhangchoxacnhan)) : ?>
                                    ...
                                    <?php foreach ($donhangchoxacnhan as $keyxacnhan => $donhangchoxacnhan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning mt-1" onclick="return confirm('Xác nhận đơn hàng?')" href="<?= BASE_URL_ADMIN ?>?act=/&day=<?= isset($day) ? $day : 1; ?>&idorder=<?= $donhangchoxacnhan['idorder'] ?>&status_delivery=1">Xác nhận</a>
                                                <a class="btn btn-danger mt-1" onclick="return confirm('Xác nhận hủy?')" href="<?= BASE_URL_ADMIN ?>?act=/&day=<?= isset($day) ? $day : 1; ?>&idorder=<?= $donhangchoxacnhan['idorder'] ?>&status_delivery=-1">Hủy đơn</a>
                                            </td>
                                        </tr>
                                ...
                                <?php if (!empty($donhangdanglay)) : ?>
                                    ...
                                    <?php foreach ($donhangdanglay as $keylay => $donhangdanglay) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning mt-1" onclick="return confirm('Xác nhận lấy thành công?')" href="<?= BASE_URL_ADMIN ?>?act=/&day=<?= isset($day) ? $day : 1; ?>&idorder=<?= $donhangdanglay['idorder'] ?>&status_delivery=2">Thành công</a>
                                            </td>
                                        </tr>
                                ...
                                <?php if (!empty($donhangchogiao)) : ?>
                                    ...
                                    <?php foreach ($donhangchogiao as $keyxacnhan => $donhangchogiao) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning mt-1" onclick="return confirm('Xác nhận giao thành công?')" href="<?= BASE_URL_ADMIN ?>?act=/&day=<?= isset($day) ? $day : 1; ?>&idorder=<?= $donhangchogiao['idorder'] ?>&status_delivery=3">Thành công</a>
                                            </td>
                                        </tr>
