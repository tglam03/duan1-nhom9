			...
			<?php foreach ($productnew as $key => $value) : ?>
				<div class="col-6 col-md-4 col-xl-3">
					<div class="grid_item">
						...
						<ul>
							<li><a class="tooltip-1" data-bs-toggle="tooltip" data-bs-placement="left" title="Thêm vào yêu thích"><i class="ti-heart"></i><span>Thêm vào yêu thích</span></a></li>
							<li><a href="<?= BASE_URL . '?act=cart-add&productID=' . $value['id'] . '&quantity=1' ?>" class="tooltip-1" data-bs-toggle="tooltip" data-bs-placement="left" title="Thêm vào giỏ hàng"><i class="ti-shopping-cart"></i><span>Thêm vào giỏ hàng</span></a></li>
						</ul>
					</div>
					<!-- /grid_item -->
				</div>
